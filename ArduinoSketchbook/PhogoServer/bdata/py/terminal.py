...
from console_proxy import Console
...
class StdOut(object):
    ...
    def write(self, value):
        ...
        console.log("{!r}".format(value))
        console.log("OUTPUT: __{!r}__".format(self.terminal.get_output()))
...
class StdErr(StdOut):
    ...
    def write(self, value):
        ...
        self.terminal.enable()
        self.terminal.pause()
        self.terminal.error(value, {"keepWords": True})
        self.terminal.resume()
        self.terminal.disable()
